...
<body>
    ...
    <div class="sigin-form">
        <form action="" method="post">
            ...
            <?php }?>
            <input type="text" placeholder="pco_name" name="pco_name" class="txtb" id="username">
            ...
            <a style=" margin: 10px 0;  background: rgba(236, 16, 8, 0.5); border-radius: 5px;" href="<?php echo base_url()?>index.php/Pco_register/pco_register">Creat Account</a>
